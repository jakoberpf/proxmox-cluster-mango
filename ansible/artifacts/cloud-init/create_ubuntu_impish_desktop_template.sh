...
# Create the instance
qm create 9013 -name ubuntu-impish-desktop-cloudinit -memory 1024 -net0 virtio,bridge=vmbr0 -cores 1 -sockets 1

# Import the OpenStack disk image to Proxmox storage
qm importdisk 9013 impish-server-cloudimg-amd64.img local-zfs

# Attach the disk to the virtual machine
qm set 9013 -scsihw virtio-scsi-pci -virtio0 local-zfs:vm-9013-disk-0

# Add a serial output
qm set 9013 -serial0 socket

# Set the bootdisk to the imported Openstack disk
qm set 9013 -boot c -bootdisk virtio0

# Enable the Qemu agent
qm set 9013 -agent 1

# Allow hotplugging of network, USB and disks
qm set 9013 -hotplug disk,network,usb
...
qm set 9013 -ide2 local-zfs:cloudinit
