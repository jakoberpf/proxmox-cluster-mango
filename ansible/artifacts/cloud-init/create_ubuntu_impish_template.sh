...
# Create the instance
qm create 9003 -name ubuntu-impish-cloudinit -memory 1024 -net0 virtio,bridge=vmbr0 -cores 1 -sockets 1

# Import the OpenStack disk image to Proxmox storage
qm importdisk 9003 impish-server-cloudimg-amd64.img local-zfs

# Attach the disk to the virtual machine
qm set 9003 -scsihw virtio-scsi-pci -virtio0 local-zfs:vm-9003-disk-0

# Add a serial output
qm set 9003 -serial0 socket
...
qm set 9003 -hotplug disk,network,usb
...
qm set 9003 -ide2 local-zfs:cloudinit
